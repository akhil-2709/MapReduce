...
public class mrweather {
    public static void main(String[] args) {
        ...
        try {
            ...
            inputdata = properties.getProperty("inputdata_mm");
            intermediate_data = properties.getProperty("intermediate_mm");
            String output_dir = "";
            String mapperType = "application.minmaxtemp.mapperweather";
            String reducerType = "application.minmaxtemp.reducerweather";
